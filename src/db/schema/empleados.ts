...
export const empleados = pgTable('empleados', {
  ...
  descuento_max_porcentaje: numeric('descuento_max_porcentaje', { precision: 5, scale: 2 })
    .default('10.00')
    .notNull(), // % máx sin aprobación de gerente
  descuento_max_monto: numeric('descuento_max_monto', { precision: 10, scale: 2 })
    .default('50000.00')
    .notNull(), // monto máx sin aprobación
