import { pgTable, serial, integer, numeric, varchar, timestamp, uuid } from 'drizzle-orm/pg-core';
...
export const detalleFactura = pgTable('detalle_factura', {
  ...
  descuento_inline_valor: numeric('descuento_inline_valor', { precision: 10, scale: 2 }).default('0').notNull(),
