...
export const CreateProductoDTO = z.object({
  ...
  proveedor_id: z.coerce.number().int().optional().nullable(),
  precio_kg: z.coerce.number().min(0).optional().default(0),
  precio_unidad: z.coerce.number().min(0).optional().default(0),
  precio_libra: z.coerce.number().min(0).optional().default(0),
  precio_detal: z.coerce.number().min(0).optional().default(0),
  precio_mayorista: z.coerce.number().min(0).optional().default(0),
